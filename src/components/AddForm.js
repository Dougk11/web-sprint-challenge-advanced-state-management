...
import {addSmurf, errorHere} from './../actions'
...
const AddForm = (props) => {
    ...
    return(<section>
        ...
        <form onSubmit={handleSubmit}>
            ...
            {
                props.error && <div data-testid="errorAlert" className="alert alert-danger" role="alert">Error: {props.errorMessage}</div>
            }
...
export default connect (mapStateToProps, {errorHere, addSmurf})(AddForm);
